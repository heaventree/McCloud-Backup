...
import { Clock, Download, ArrowRight, Share2, FileUp, Sliders, Loader2 } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
const RecentBackups = ({ limit = 5 }: RecentBackupsProps) => {
  ...
  const joinedBackups: JoinedBackup[] =
    backups &&
    sites &&
    storageProviders &&
    ...
    <div className="card">
      ...
      <div className="card-body p-0">
        {isLoading ? (
          ...
          <div className="py-8 text-center text-red-500">Failed to load recent backups</div>
        ) : joinedBackups.length === 0 ? (
          <div className="py-8 text-center text-gray-500">No recent backups found</div>
        ) : (
                  ...
                  <tr key={backup.id}>
                    <td>
                      <div className="flex items-center">
                        <div className="mr-3 flex h-8 w-8 items-center justify-center rounded bg-blue-50 text-blue-600">
                    ...
                    <td>
                      <div className="flex items-center">
                        <div className="mr-2 flex h-6 w-6 items-center justify-center rounded bg-gray-100 text-gray-500">
                          {backup.storageProvider ? (
                            <SvglIcon
                              providerType={backup.storageProvider?.type}
                              width={14}
                              height={14}
                            />
                          ) : (
